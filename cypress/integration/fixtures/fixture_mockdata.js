...
describe("Carga por fixtures", () =>{
    ...
    cy.fixture("Excel_Json").then(tesdata => { // EJ,EXC_JSON->  SI DA ERROR,CREAR UN ARHIVO NUEVO JSON Y COPIAR CODIGO [ ] ,MOCK_DATA-> OK /Gracias a Mockdata, puedes crear valores aleatorios sin esribirlos.
